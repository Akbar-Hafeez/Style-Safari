    ...
    <div class="font-[sans-serif] bg-gray-50">
      <div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-4 h-full">
        ...
        <div class="xl:col-span-2 h-max rounded-md p-8 sticky top-0">
          <h2 class="text-2xl font-bold text-[#333]">Delivery Address</h2>
          <form onSubmit={handleSubmit} class="mt-10">
            <div>
              ...
              <div class="grid sm:grid-cols-2 gap-6">
                ...
                <div class="relative flex items-center">
                  <input type="text" name="lastName" autoComplete='given-name' placeholder="Last Name"
                    class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-4"
                    viewBox="0 0 24 24">
                    <circle cx="10" cy="7" r="6" data-original="#000000"></circle>
                ...
                <div class="relative flex items-center">
                  <input type="email" name='email'  autoComplete='given-name' placeholder="Email"
                    class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
                  <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-4"
                ...
                <div class="relative flex items-center">
                  <input type="number" name='number' autoComplete='given-name' placeholder="Phone No."
                    class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
            ...
            <div class="mt-6">
              ...
              <div class="grid sm:grid-cols-2 gap-6">
                <input type="text" name="streetAddress" autoComplete='given-name' placeholder="Street Address"
                  class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
                <input type="text" placeholder="City" name="city" autoComplete='given-name'
                  class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
                <input type="text" placeholder="State" name="state" autoComplete='given-name'
                  class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
                <input type="text" placeholder="Zip Code" name="zipCode" autoComplete='shipping postal-code'
                  class="px-4 py-3.5 bg-white text-[#333] w-full text-sm border-b-2 focus:border-[#333] outline-none" />
              </div>
              <div class="flex justify-center gap-6 max-sm:flex-col mt-10">
               
                <button  type="submit" class="rounded-md px-14  py-3 text-sm font-semibold bg-[#333] text-white hover:bg-[#222]">Deliver Here</button>
              </div>
            </div>
          </form>
        </div>
